  ...
  return {
    main: {
      ...
      define: {
        ...
        "process.env.CHATBOX_BUILD_TARGET": JSON.stringify(
          process.env.CHATBOX_BUILD_TARGET || "unknown",
        ),
        "process.env.CHATBOX_BUILD_PLATFORM": JSON.stringify(
          process.env.CHATBOX_BUILD_PLATFORM || "unknown",
        ),
